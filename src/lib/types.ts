...
export type Region = 'asia' | 'europe' | 'africa' | 'north-africa' | 'oceania' | 'america' | 'carribean' | 'south-america' | 'ex-ussr' | 'european-union' | 'middle-east' | 'central-america' | 'north-america'
