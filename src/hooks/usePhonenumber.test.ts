  ...
  describe("INTERNATIONAL", () => {
    describe("default", () => {
      it("should have initial country undefined", () => {
        const { result } = renderHook(() =>
          usePhonenumber({ format: "INTERNATIONAL" }),
        );
    ...
    describe("With intial Country", () => {
      it("should have initial country", () => {
        ...
        const { result } = renderHook(() =>
          usePhonenumber({ format: "INTERNATIONAL", initialCountry: expected }),
        );
    ...
    describe("With intial value", () => {
      it("should have initial country", () => {
        ...
        const { result } = renderHook(() =>
          usePhonenumber({ format: "INTERNATIONAL", initialValue: expected }),
        );
